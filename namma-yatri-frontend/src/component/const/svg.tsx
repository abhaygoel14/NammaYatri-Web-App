...
export const SmallSquareSVG = () => {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none">
      <title>Square small</title>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
export const WalletSVG = () => {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none">
      <title>Wallet</title>
      <path
        d="M14.12 14H9.88l-3-3H1v9h22v-9h-5.88l-3 3z"
        fill="currentColor"
      ></path>
      ,<path d="M1 4v4h7.12l3 3h1.76l3-3H23V4H1z" fill="currentColor"></path>
    </svg>
  );
};
...
export const TagSVG = () => {
  return (
    <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none">
      <title>Tag</title>
      <path d="M10 24l12-12V2H12L0 14l10 10z" fill="currentColor"></path>
    </svg>
  );
};
...
export const CancelSVG = () => {
  return (
    <svg
      ...
      role="button"
      className="_css-kAOgSm"
    >
      <title>Clear value</title>
      <path
        d="M12 1C5.9 1 1 5.9 1 12s4.9 11 11 11 11-4.9 11-11S18.1 1 12 1zm6 15l-2 2-4-4-4 4-2-2 4-4-4-4 2-2 4 4 4-4 2 2-4 4 4 4z"
        fill="currentColor"
      ></path>
    </svg>
  );
...
export const GoogleSVG = () => {
  return (
    ...
    >
      <path
        d="M255.9 133.5c0-10.8-.9-18.6-2.8-26.7H130.6v48.4h71.9a63.8 63.8 0 01-26.7 42.4l-.2 1.6 38.7 30 2.7.3c24.7-22.8 38.9-56.3 38.9-96"
        fill="#4285F4"
      ></path>
      <path
        d="M130.6 261.1c35.2 0 64.8-11.6 86.4-31.6l-41.2-32c-11 7.8-25.8 13.1-45.2 13.1a78.6 78.6 0 01-74.3-54.2l-1.5.1-40.3 31.2-.6 1.5C35.4 231.8 79.5 261 130.6 261"
        fill="#34A853"
      ></path>
      <path
        d="M56.3 156.4a80.4 80.4 0 01-.2-51.7V103L15.3 71.3l-1.4.6a130.7 130.7 0 000 117.3l42.4-32.8"
        fill="#FBBC05"
      ></path>
      <path
        d="M130.6 50.5c24.5 0 41 10.6 50.4 19.4L218 34C195.2 13 165.8 0 130.6 0 79.5 0 35.4 29.3 13.9 72l42.2 32.7a79 79 0 0174.4-54.2"
        fill="#EB4335"
      ></path>
    </svg>
  );
